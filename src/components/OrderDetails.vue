    ...
    <q-card class="bg-mygrey1">
      ...
      <template v-if="data && !loading">
        <div class="q-pa-md q-gutter-y-md">
          ...
          <q-card-section class="radius8 box-shadow0 bg-white q-pa-xs">
          ...
          <q-card-section
            class="radius8 box-shadow0 bg-white q-pa-md custom-stepper"
          >
            <q-stepper v-model="step" vertical color="primary" flat animated>
              <q-step
                ...
                done-icon="o_storefront"
                active-icon="o_storefront"
                icon="o_storefront"
                class="q-pb-md"
              >
              </q-step>
              <q-step
                ...
                done-icon="o_location_on"
                active-icon="o_location_on"
                icon="o_location_on"
              >
              </q-step>
            </q-stepper>
            ...
            <template v-if="getOrderType == 'delivery'">
              ...
              <q-item>
                <q-item-section>
                  ...
                  <q-item-label caption>
                    {{
                      data?.order?.order_info?.delivery_instructions ||
                      $t("None")
                    }}
                  </q-item-label>
                </q-item-section>
          ...
          <template v-if="show_actions">
            <q-card-section
              ...
              class="radius8 box-shadow0 bg-white q-pa-xs q-pl-md q-pr-md q-gutter-x-md flex justify-end"
            >
              <q-btn
                v-if="data.allowed_to_cancel"
                label="Cancel"
          ...
          <q-card-section class="radius8 box-shadow0 bg-white q-pa-xs">
            <q-list dense>
              <template v-for="summary in getSummary" :key="summary">
                <q-item
                  :class="{ 'text-weight-bold': summary.type == 'total' }"
                >
                ...
                <q-item-section side class="text-weight-bold">
                  {{
                    data.order.order_info
                      .total_from_used_currency_to_based_currency_pretty
                  }}
                </q-item-section>
              </q-item>
            </q-list>
          ...
          <q-card-section
            class="radius8 box-shadow0 bg-white q-pa-xs"
